...
> 📸 [SCREENSHOT: Suno 가격 페이지의 Plus·Pro·Premier 플랜 비교 표 캡쳐]
...
> 📸 [SCREENSHOT: DAW에서 MP3 트랙과 WAV 트랙의 주파수 스펙트럼 분석 비교 — 고음역 차이 시각화]
...
> 📸 [SCREENSHOT: 같은 시점에 Free·Plus·Pro 계정에서 곡 생성 시작 후 결과 도착까지의 타이머 비교]
...
> 📸 [SCREENSHOT: 한 사용자의 월별 크레딧 소진 그래프 — Plus 크레딧이 매월 25일경 소진되는 사례]
