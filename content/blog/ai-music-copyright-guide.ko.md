...
> 📸 [SCREENSHOT: Suno 공식 Terms of Service 페이지 — Plan-specific Rights 섹션 캡처]
...
> 📸 [SCREENSHOT: 미국 저작권청(U.S. Copyright Office) 공식 AI 가이드라인 페이지 — Authorship 섹션]
...
> 📸 [SCREENSHOT: Suno Pro 구독 페이지 — Commercial Use 권리 명시 섹션]
...
> 📸 [SCREENSHOT: 유튜브 스튜디오 업로드 화면 — "합성 또는 변형된 콘텐츠" 공시 옵션]
...
> 📸 [SCREENSHOT: 한국저작권위원회 또는 한국 문화체육관광부 AI 산출물 안내서 페이지]
